...
const Header = () => {
    ...
    const loginButton = (<ul>
        <li>
            <Link className={classes.active} to='/'><p>Home</p></Link>
        </li>
        <li>
            <Button 
    ...
    const logoutButton = (<ul>
        <li>
            <Link className={classes.active} to='/profile'>
                <p>Profile</p>
            </Link>
        </li>
        <li>
    ...
    return (
        <header>
            ...
            {(showLogin || showRegister) && <Authentication
                onClose = {closeHandler}
                registerStatus = {showRegister} 
